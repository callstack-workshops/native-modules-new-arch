///
/// HybridNitroMapViewManager.kt
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/mrousavy/nitro
/// Copyright © Marc Rousavy @ Margelo
///

package com.margelo.nitro.nitromapview.views
...
import com.margelo.nitro.nitromapview.*

/**
 * Represents the React Native `ViewManager` for the "NitroMapView" Nitro HybridView.
 */
public class HybridNitroMapViewManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridMapView::class.java)) {
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridNitroMapViewStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): HybridMapView? {
    return view.getTag(associated_hybrid_view_tag) as? HybridMapView
  }
}
