...
namespace margelo::nitro::math {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/math/Func_void_double;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/math/Func_void_double_cxx;";
