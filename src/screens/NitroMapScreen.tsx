...
import NitroMapViewConfig from 'nitro-mapview/nitrogen/generated/shared/json/NitroMapViewConfig.json';

const MapView = getHostComponent<NitroMapViewProps, NitroMapViewMethods>(
  'NitroMapView',
  () => NitroMapViewConfig,
);
...
export function NitroMapScreen() {
